 ...
 */
public final class FastScrollingView extends ViewGroup {
    ...
    private final ViewDraugHelper drugHelper;
    ...
    public FastScrollingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        drugHelper = ViewDraugHelper.create(this, new DragCallback());
    ...
    public void moveHandleToPosition() {
        ...
        if (drugHelper.getViewDragState() != ViewDraugHelper.STATE_IDLE) {
    ...
    final class TrackEventHandler extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            if (track != null && thumb != null) {
                ...
                ViewCompat.postInvalidateOnAnimation(FastScrollingView.this);
    ...
    final class DragCallback extends ViewDraugHelper.Callback {
        @Override
        ...
        public void onViewDragStateChanged(int state) {
            if (state != ViewDraugHelper.STATE_DRAGGING) {
